...
class SupabaseSyncJob(
    ...
    @Inject
    private lateinit var runtime: SupabaseSyncRuntime
    ...
    companion object {
        private const val WORK_NAME = "TsuzukiSupabaseSync-periodic"
        ...
        fun setupTask(context: Context) {
            ...
            val request = PeriodicWorkRequestBuilder<SupabaseSyncJob>(
                6,
                TimeUnit.HOURS,
                30,
                TimeUnit.MINUTES,
